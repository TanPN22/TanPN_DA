...
void ADE7753_transfer(uint8_t address, uint8_t *data, uint8_t length)
{
    ...
    esp_rom_delay_us(ADE7753_TRA_DEL);
}
...
double ADE7753_readCurrentRMS()
{
    return ADE7753_readRegister(ADE7753_IRMS, 3);
}

double ADE7753_readVoltageRMS()
{
    return ADE7753_readRegister(ADE7753_VRMS, 3);
}

void ADE7753_setInterrupt(uint16_t intMode)
{
    ADE7753_writeMaskRegister(ADE7753_IRQEN, intMode, 2, intMode);
}

void ADE7753_setWaveSelect(uint16_t wavsel)
{
    ADE7753_writeMaskRegister(ADE7753_MODE, wavsel, 2, ADE7753_WAVSEL);
}

void ADE7753_setDataRate(uint16_t dtrt)
{
    ADE7753_writeMaskRegister(ADE7753_MODE, dtrt, 2, ADE7753_DTRT);
}

uint16_t ADE7753_status()
{
    return ADE7753_readRegister(ADE7753_RSTSTATUS, 2);
}